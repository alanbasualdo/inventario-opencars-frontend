...
export const CelularesModelos = () => {

  const { startGetModelos, startPostModelo, startDeleteModelo, modelos } = useCelStore()
  ...
  return (
    <>
      <button className="btn btn-sm btn-outline-primary animate__animated animate__fadeIn" type="button" title='Agregar modelo' onClick={handleShow}>Modelos</button>
